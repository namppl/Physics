...
struct RorCB{
    ...
    RorCB(double m_, double s_, double a_, double n_){
	init(m_, s_, a_, n_);
    }
...
const double RorCB::pi    = TMath::Pi();
const double RorCB::SPiO2 = sqrt(TMath::Pi()/2.0);
const double RorCB::S2    = sqrt(2.0);
